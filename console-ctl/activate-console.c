...
int activate_console_by_id(struct sd_bus *bus, char *console_id, bool arg, bool debug)
{
	...
	return activate_console(bus, dbus_name_active_console, dbus_path_active_console, arg, debug);
}
